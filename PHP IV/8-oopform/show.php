      ...
      <form action="controller.php" method="post">
        ...
        <div class="mb-3">
          ...
          <select class="form-select" aria-label="Category" id="productCategory" name="category" required>
            ...
            <option value="processor" <?= $product instanceof Processor ? 'selected' : '' ?>>Processor</option>
    ...
    function displaySpecificFields() {
      ...
      switch (category) {
        case 'processor':
          ...
          <input type="range" class="form-range" aria-label="Cores" aria-describedby="coreNumber" min="1" max="32" name="cores" id="coreNumber" value="<?= $product instanceof Processor ? $product->getCores() : 1 ?>" required>
          `;
        ...
        case 'storage':
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" name="storageType" id="storageTypeHDD" value="HDD" <?= $product instanceof Storage && $product->getType() == 'HDD' ? 'checked' : '' ?>>
            <label class="form-check-label" for="storageTypeHDD">
              HDD
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="storageType" id="storageTypeSSD" value="SSD" <?= $product instanceof Storage && $product->getType() == 'SSD' ? 'checked' : '' ?>>
        ...
        case 'memory':
          ...
          <input type="text" class="form-control" id="componentSize" placeholder="Size" name="size" value="<?= ($product instanceof RAM || $product instanceof VGA) ? $product->getSize() : '' ?>" required>
          `;
          break;
        default:
          whereToPut.innerHTML = '';
